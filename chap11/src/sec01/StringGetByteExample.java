...
public class StringGetByteExample {
	...
	public static void main(String[] args) {
		...
		byte[] bytes1 = str1.getBytes();		//인코딩(encoding) 아무것도 적지 않으며 utf8
		...
		try {
			...
			byte[] bytes4 = str1.getBytes("utf-8");	//utf-8로 인코딩	utf-8은 3byte 	ex)아ㄴ->3byte
			System.out.println("bytes4.length: " + bytes4.length);	//2byte*5 ->10개
			String str6 = new String(bytes4,"utf-8"); // euc-kr로 디코딩(decoding)
